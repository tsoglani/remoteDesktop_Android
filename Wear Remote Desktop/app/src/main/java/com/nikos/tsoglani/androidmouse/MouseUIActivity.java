            ...
            protected Void doInBackground(Void... params) {
                if (InternetConnection.returnSocket == null) {
                    ...
                    try {
                        ...
                        if (type != null && type.equals("Wear")) {
                            qualityCam = qualityPad = 50;
                        }
                                ...
                                try {
                                    ...
                                    if ((!PageOneFragment.waitUntilDraw) && getComputerScreen) {//
                                        ...
                                        if (bitmapimage != null) {
                                            ...
                                            final RelativeLayout iv = (RelativeLayout) activity.findViewById(R.id.mousepad_screen);
...
//                                                                client=null;
                                        ...
                                        final RelativeLayout iv = (RelativeLayout) activity.findViewById(R.id.imageView);
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_USER);
        LinearLayout content_frame = (LinearLayout) findViewById(R.id.content_frame);
