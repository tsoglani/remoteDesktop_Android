...
public class PageOneFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(com.remote.tsoglanakos.desktop.R.layout.fragment_one, container, false);
    }
...
//                            second_coursor.setY(fl.getHeight() / 2);
    ...
    private void drawLastImage(final Bitmap bitmapimage) {
        ...
        if (bitmapimage != null) {
            ...
            final ImageView iv = (ImageView) getActivity().findViewById(R.id.mousepad_screen);
            getActivity().runOnUiThread(new Thread() {
                @Override
                public void run() {
